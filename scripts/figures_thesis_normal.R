...
for(i in 1:10000){
  sim <- sim_data(group_sizes = c(3, 4, 3),
                  dist = "normal", corr = 0.2,
                  params1 = c(50, 20), params2 = c(10, 2))
...
for(i in 1:10000){
  sim <- sim_data(group_sizes = c(8, 7, 9),
                  dist = "normal", corr = 0.2,
                  params1 = c(50, 20), params2 = c(10, 2))
...
for(i in 1:10000){
  sim <- sim_data(group_sizes = c(15, 14, 15),
                  dist = "normal", corr = 0.2,
                  params1 = c(50, 20), params2 = c(10, 2))
...
for(i in 1:10000){
  sim <- sim_data(group_sizes = c(30, 33, 35),
                  dist = "normal", corr = 0.2,
                  params1 = c(50, 20), params2 = c(10, 2))
...
hist_theory <- sim_theory_num(g = 3, dist = "normal", corr = 0.2,
                              params1 = c(50, 20), params2 = c(10, 2), trials = 100000, 
                              omega = 1)

num_theory <- as.data.frame(hist_theory)

den_theory <- sim_theory_den(dist = "normal", params1 = c(50, 20), params2 = c(10, 2), omega = 1)
